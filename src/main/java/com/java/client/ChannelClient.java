...
public class ChannelClient {
	 ...
	 * @throws IOException
	 */
	public Collection<ProposalResponse> instantiateChainCode(String chaincodeName, String version, ChaincodeID ccid,
			Type language, String functionName, String[] functionArgs, String policyPath)
...
//		instantiateProposalRequest.setTransientMap(tm);
	 ...
	 * @throws IOException
	 */
	public Collection<ProposalResponse> upgradeChainCode(String chaincodeName, String version, ChaincodeID ccid,
			Type language, String functionName, String[] functionArgs, String policyPath)
			throws InvalidArgumentException, ProposalException, ChaincodeEndorsementPolicyParseException, IOException {
		Logger.getLogger(ChannelClient.class.getName()).log(Level.INFO,
		...
		upgradeProposalRequest.setProposalWaitTime(360000);
		 
		
		Logger.getLogger(ChannelClient.class.getName()).log(Level.INFO,
				"Upgrading Chaincode ID " + chaincodeName + " on channel " + channel.getName());
		
		upgradeProposalRequest.setChaincodeID(ccid);
		
		upgradeProposalRequest.setChaincodeLanguage(language);
...
//		upgradeProposalRequest.setTransientMap(tm);
		...
		Logger.getLogger(ChannelClient.class.getName()).log(Level.INFO,
				"Chaincode " + chaincodeName + " on channel " + channel.getName() + " upgradation " + cf);
		return responses;
	}
